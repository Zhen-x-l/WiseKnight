...
**智慧骑士系统**是一个基于视觉语言模型的智能分析平台，专门用于识别和分析楼道场景中的消防隐患。系统能够自动检测楼道环境，评估消防隐患等级。
...
### 核心技术栈
- **视觉大模型**：基于llama 3.2的视觉语言模型
- **高效微调和推理优化框架**：unsloth
- **系统界面**：基于Gradio框架构建，辅以html、css界面定制
...
data_sample目录下提供了上述5种类别标签的样例数据，每类样例数据各5张图片。这些数据可以用于智慧骑士系统的展示。
下面是智慧骑士系统使用的动图展示。同时我们也提供了相应的展示视频，展示视频存放在assets/videos/show.mp4路径，如有需要可以观看。

<div align="center">
<h1><strong>智慧骑士系统使用展示</strong><h1>
